...
declare namespace _browser.alarms {
    type Alarm = {
        name: string,
...
declare namespace _browser.bookmarks {
...
declare namespace _browser.browserAction {
    ...
    const onClicked: Listener<_browser.tabs.Tab>;
}

declare namespace _browser.browsingData {
    type DataTypeSet = {
        cache?: boolean,
        cookies?: boolean,
        downloads?: boolean,
...
declare namespace _browser.commands {
    type Command = {
        name?: string,
        description?: string,
        shortcut?: string,
...
declare namespace _browser.contextMenus {
    ...
    function create(createProperties: {
        ...
        onclick?: (info: OnClickData, tab: _browser.tabs.Tab) => void,
    ...
    const onClicked: EvListener<(info: OnClickData, tab: _browser.tabs.Tab) => void>;
}

declare namespace _browser.contextualIdentities {
...
declare namespace _browser.cookies {
    type Cookie = {
        name: string,
        value: string,
        domain: string,
...
declare namespace _browser.devtools.inspectedWindow {
    const tabId: number;
...
declare namespace _browser.devtools.network {
    const onNavigated: Listener<string>;
}

declare namespace _browser.devtools.panels {
    type ExtensionPanel = {
...
declare namespace _browser.downloads {
...
declare namespace _browser.events {
    type UrlFilter = {
        hostContains?: string,
        hostEquals?: string,
        hostPrefix?: string,
...
declare namespace _browser.extension {
...
declare namespace _browser.extensionTypes {
...
declare namespace _browser.history {
...
declare namespace _browser.i18n {
...
declare namespace _browser.management {
    type ExtensionInfo = {
        description: string,
...
declare namespace _browser.notifications {
...
declare namespace _browser.omnibox {
...
declare namespace _browser.pageAction {
    type ImageDataType = ImageData;
...
declare namespace _browser.permissions {
...
declare namespace _browser.sessions{
    type Filter = { maxResults?: number }

    type Session = {
        lastModified: number,
        tab: _browser.tabs.Tab,
        window: _browser.windows.Window
    }
...
declare namespace _browser.sidebarAction {
    type ImageDataType = ImageData;
...
declare namespace _browser.tabs {
    ...
    function connect(tabId: number, connectInfo?: { name?: string, frameId?: number }): _browser.runtime.Port;
    function create(createProperties: {
        active?: boolean,
        cookieStoreId?: string,
        index?: number,
    ...
    function insertCSS(tabId: number|undefined, details: _browser.extensionTypes.InjectDetailsCSS): Promise<void>;
    function removeCSS(tabId: number|undefined, details: _browser.extensionTypes.InjectDetails): Promise<void>;
...
declare namespace _browser.topSites {
    type MostVisitedURL = {
        title: string,
        url: string,
    };
...
declare namespace _browser.webNavigation {
...
declare namespace _browser.webRequest {
...
declare namespace _browser.windows {
    type WindowType = "normal" | "popup" | "panel" | "devtools";
    ...
    }): Promise<_browser.windows.Window>;
    ...
    const onCreated: Listener<_browser.windows.Window>;
...
declare namespace _browser.theme {
