	...
	storage: {
		...
		sync: {
			set: function(key, value) {
				/// <summary>
				/// Sets a key in chrome.storage, or completely rewrites if no key is given
				/// </summary>
				/// <param name="key" type='string'> (optional) Key</param>
				/// <param name="value" type='object'> Data to set </param>
			},
			get: function(key, callback) {
				/// <summary>
				/// Gets the given key and calls the callback
				/// </summary>
				/// <param name="key" type='string'> (optional) the key to find</param>
				/// <param name="callback" type='function'>function(object items) {...} ;</param>
			}
		},
		local: {
			set: function(key, value) {
