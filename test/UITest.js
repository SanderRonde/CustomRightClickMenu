        ...
        describe('Theme', function () {
            it('is changable', function (done) {
                resetSettingsPromise().then(function () {
                    ...
                    assert.strictEqual(settings.editor.theme, 'default', 'theme has been switched to default (white)');
                    done();
                });
            });
            ...
            it('is changable', function (done) {
                resetSettingsPromise().then(function () {
                    ...
                    return dialog
                        ...
                        .findElement(webdriver.By.tagName('input'))
                        .sendKeys(webdriver.Key.BACK_SPACE, webdriver.Key.BACK_SPACE, webdriver.Key.BACK_SPACE, newTabSize);
                }).then(function () {
                    return getSyncSettings(driver);
                }).then(function (settings) {
...
describe('On-Page CRM', function () {
    describe('Links', function () {
        it('match the given names', function (done) {
        });
    });
});
