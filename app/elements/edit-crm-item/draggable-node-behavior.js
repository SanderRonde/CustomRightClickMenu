Polymer.DraggableNodeBehavior = {
	...
	/**
	  * Whether this item is currently being dragged
	  *
	  * @attribute _cursorPosChanged
	  * @type boolean
	  * @default false
	  */
	_cursorPosChanged: true,

	/**
     * The last recorded position of the mouse
     *
     * @attribute _lastRecordedPos
     * @type Object
     * @default { X: 0, Y: 0 }
     */
	_lastRecordedPos: {
     ...
     *
     * @attribute _readyForMouseUp
     * @type Boolean
     * @default true
     */
	_readyForMouseUp: true,

	/**
     * Whether the element should execute a mouse-up event when ready for it
     *
     * @attribute _execMouseUp
     * @type Boolean
     * @default false
     */
	_execMouseUp: false,
	 ...
	 * 
	 * @attribute _currentColumn
	 * @type element
	 * @default null
	 */
	_currentColumn: null,

	_changeDraggingState: function(isDragging) {
