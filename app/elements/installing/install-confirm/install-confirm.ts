...
namespace InstallConfirmElement {
	...
	export class IC {
		...
		static getDescription(this: InstallConfirm, permission: CRM.Permission): string {
			const descriptions = {
				alarms: this.___prom(I18NKeys.permissions.alarms),
				activeTab: this.___prom(I18NKeys.permissions.activeTab),
				background: this.___prom(I18NKeys.permissions.background),
				bookmarks: this.___prom(I18NKeys.permissions.bookmarks),
				browsingData: this.___prom(I18NKeys.permissions.browsingData),
				clipboardRead: this.___prom(I18NKeys.permissions.clipboardRead),
				clipboardWrite: this.___prom(I18NKeys.permissions.clipboardWrite),
				cookies: this.___prom(I18NKeys.permissions.cookies),
				contentSettings: this.___prom(I18NKeys.permissions.contentSettings),
				contextMenus: this.___prom(I18NKeys.permissions.contextMenus),
				declarativeContent: this.___prom(I18NKeys.permissions.declarativeContent),
				desktopCapture: this.___prom(I18NKeys.permissions.desktopCapture),
				downloads: this.___prom(I18NKeys.permissions.downloads),
				history: this.___prom(I18NKeys.permissions.history),
				identity: this.___prom(I18NKeys.permissions.identity),
				idle: this.___prom(I18NKeys.permissions.idle),
				management: this.___prom(I18NKeys.permissions.management),
				notifications: this.___prom(I18NKeys.permissions.notifications),
				pageCapture: this.___prom(I18NKeys.permissions.pageCapture),
				power: this.___prom(I18NKeys.permissions.power),
				privacy: this.___prom(I18NKeys.permissions.privacy),
				printerProvider: this.___prom(I18NKeys.permissions.printerProvider),
				sessions: this.___prom(I18NKeys.permissions.sessions),
				"system.cpu": this.___prom(I18NKeys.permissions.systemcpu),
				"system.memory": this.___prom(I18NKeys.permissions.systemmemory),
				"system.storage": this.___prom(I18NKeys.permissions.systemstorage),
				topSites: this.___prom(I18NKeys.permissions.topSites),
				tabCapture: this.___prom(I18NKeys.permissions.tabCapture),
				tabs: this.___prom(I18NKeys.permissions.tabs),
				tts: this.___prom(I18NKeys.permissions.tts),
				webNavigation: this.___prom(I18NKeys.permissions.webNavigation) +
				' (https://developer.chrome.com/extensions/webNavigation)',
				webRequest: this.___prom(I18NKeys.permissions.webRequest),
				webRequestBlocking: this.___prom(I18NKeys.permissions.webRequestBlocking),

				//Script-specific descriptions
				crmGet: this.___prom(I18NKeys.permissions.crmGet),
				crmWrite: this.___prom(I18NKeys.permissions.crmWrite),
				crmRun: this.___prom(I18NKeys.permissions.crmRun),
				crmContextmenu: this.___prom(I18NKeys.permissions.crmContextmenu),
				chrome: this.___prom(I18NKeys.permissions.chrome),
				browser: this.___prom(I18NKeys.permissions.browser),

				//Tampermonkey APIs
				GM_addStyle: this.___prom(I18NKeys.permissions.GMAddStyle),
				GM_deleteValue: this.___prom(I18NKeys.permissions.GMDeleteValue),
				GM_listValues: this.___prom(I18NKeys.permissions.GMListValues),
				GM_addValueChangeListener: this.___prom(I18NKeys.permissions.GMAddValueChangeListener),
				GM_removeValueChangeListener: this.___prom(I18NKeys.permissions.GMRemoveValueChangeListener),
				GM_setValue: this.___prom(I18NKeys.permissions.GMSetValue),
				GM_getValue: this.___prom(I18NKeys.permissions.GMGetValue),
				GM_log: this.___prom(I18NKeys.permissions.GMLog),
				GM_getResourceText: this.___prom(I18NKeys.permissions.GMGetResourceText),
				GM_getResourceURL: this.___prom(I18NKeys.permissions.GMGetResourceURL),
				GM_registerMenuCommand: this.___prom(I18NKeys.permissions.GMRegisterMenuCommand),
				GM_unregisterMenuCommand: this.___prom(I18NKeys.permissions.GMUnregisterMenuCommand),
				GM_openInTab: this.___prom(I18NKeys.permissions.GMOpenInTab),
				GM_xmlhttpRequest: this.___prom(I18NKeys.permissions.GMXmlhttpRequest),
				GM_download: this.___prom(I18NKeys.permissions.GMDownload),
				GM_getTab: this.___prom(I18NKeys.permissions.GMGetTab),
				GM_saveTab: this.___prom(I18NKeys.permissions.GMSaveTab),
				GM_getTabs: this.___prom(I18NKeys.permissions.GMGetTabs),
				GM_notification: this.___prom(I18NKeys.permissions.GMNotification),
				GM_setClipboard: this.___prom(I18NKeys.permissions.GMSetClipboard),
				GM_info: this.___prom(I18NKeys.permissions.GMInfo),
				unsafeWindow: this.___prom(I18NKeys.permissions.unsafeWindow)
			};
					...
					if (permissions.indexOf(permission as _browser.permissions.Permission) === -1) {
						try {
							if (!(browserAPI.permissions)) {
								window.app.util.showToast(this.___prom(I18NKeys.install.confirm.notAsking,
									permission));
								return;
							}
