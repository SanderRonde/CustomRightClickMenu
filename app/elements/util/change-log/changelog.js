...
((cl) => {
	...
	(function (config) {
		...
		const changelog = {
			...
			'2.0.9': ['Fixed bug with buttons no longer working'],
			'2.0.10': ['Fixed a bug in the crmAPI.GM.GM_notification function'],
			'2.0.11': [
			...
			'2.1.5': ['Attempt fix dragging of nodes'],
			'2.1.6': ['Fix dragging of nodes'],
			'2.1.7': ['Remove some bad practices in code (eval use etc).'],
			'2.1.8': [
			...
			'2.2.3': ['Replaced JQuery 2.* with JQuery 3.3.1'],
			'2.2.4': [
				'Now uses synced data of previous instances when downloading the extension on a new computer',
			],
			'2.2.5': ['Fix bug that happened when upgrading version'],
			'2.2.6': [
			...
			'2.2.7': ['Fix more dragging issues'],
			'2.2.8': [
