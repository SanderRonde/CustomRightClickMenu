...
var SCE = (function () {
     ...
     */
    SCE.insertSnippet = function (_this, snippet, noReplace) {
    ...
    /*
        ...
        */
    SCE.popOutToolsRibbon = function () {
        window.doc['editorToolsRibbonContainer'].animate([
            {
                marginLeft: 0
            }, {
     ...
     * icons' positions
     */
    SCE.scrollbarsUpdate = function (vertical) {
 ...
 */
SCE.verticalVisible = false;
/**
 * Whether the horizontal scrollbar is already shown
 */
SCE.horizontalVisible = false;
/**
 ...
 */
SCE.preventNotification = false;
/**
 * The timeout that resets the preventNotification bool
 */
SCE.preventNotificationTimeout = null;
/**
 ...
 */
SCE.fullscreenAnimation = null;
/**
 * The show options animation player
 */
SCE.optionsAnimations = [];
SCE.keyBindings = [
    {
        name: 'AutoComplete',
