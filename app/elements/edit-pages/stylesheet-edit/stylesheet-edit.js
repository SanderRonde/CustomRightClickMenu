...
var STE = (function () {
     ...
     */
    STE.insertSnippet = function (_this, snippet, noReplace) {
     ...
     */
    STE.popOutToolsRibbon = function () {
        window.doc['editorToolsRibbonContainer'].animate([
            {
                marginLeft: 0
            }, {
     ...
     * icons' positions
     */
    STE.scrollbarsUpdate = function (vertical) {
 ...
 */
STE.verticalVisible = false;
/**
 * Whether the horizontal scrollbar is already shown
 */
STE.horizontalVisible = false;
/**
