...
interface IDMap 
{
	...
	"script-edit":{
		...
		"cancelButton": HTMLPaperButtonElement,
		"saveButton": HTMLPaperButtonElement,
		"editorOptionsTemplate": HTMLTemplateElement,
		...
		"editorTabsOrSpacesSettingCont": HTMLDivElement,
		"editorTabsOrSpacesCheckbox": HTMLDivElement,
		"editorTabsOrSpacesTxt": HTMLDivElement,
		"editorTabSizeSettingCont": HTMLDivElement,
		"editorTabSizeInput": HTMLDivElement,
		...
		"keyBindingTemplate": HTMLTemplateElement
	},
	"stylesheet-edit":{
		"codeEditCont": HTMLDivElement,
		"settingsCont": HTMLDivElement,
