...
export const Messages: LocaleSpec = {
	generic: {
		...
		back: {
			message: 'BACK',
			description:
				'Button that switches to the previous item in some list',
		},
		confirm: {
			message: 'Confirm',
		...
		cancel: {
			message: 'cancel',
			description:
				'A button that cancels the current operation or dialog',
		},
		save: {
			message: 'save',
		...
		all_capital: {
			message: 'ALL',
			description:
				'Would be clicked to select all items in a list for a filter (capitalized)',
		},
		tab: {
			message: 'Tab',
		...
		tabIndex: {
			message: 'TabIndex',
			description:
				'The index of a script within a tab. First letter capitalized',
		},
		url: {
			message: 'url',
	...
	crmTypes: {
		...
		weblinks: {
			message: 'weblinks',
			description:
				'A short description for weblinks (HTML anchor elements)',
		},
		selection: {
			message: 'selection',
	...
	crm: {
		...
		script: {
			message: 'Script',
			description:
				'Name of the script node type. Used like: "Add {Script}"',
		},
		stylesheet: {
			message: 'Stylesheet',
			description:
				'Name of the stylesheet node type. Used like: "Add {Stylesheet}"',
		},
		menu: {
			message: 'Menu',
		...
		divider: {
			message: 'Divider',
			description:
				'Name of the divider node type. Used like: "Add {Divider}"',
		},
		exampleLinkName: {
			message: 'My Link',
		...
		id: {
			message: 'id',
			description:
				'Word for the ID of a node/item. ' +
		...
		idCapital: {
			message: 'ID',
			description:
				'Word for the ID of a node/item. This is ' +
	...
	permissions: {
		...
		cookies: {
			message:
				'Allows for the setting, getting and listening for ' +
		...
		contentSettings: {
			message:
				'Allows changing or reading your browser settings ' +
		...
		declarativeContent: {
			message:
				'Allows for the running of scripts on pages based on ' +
		...
		desktopCapture: {
			message:
				'Makes it possible to capture your screen, current tab ' +
		...
		downloads: {
			message:
				'Allows for the creating, pausing, searching and ' +
		...
		history: {
			message:
				'Makes it possible to read your history and remove/add ' +
		...
		identity: {
			message:
				'Allows for the API to ask you to provide your (google) ' +
		...
		printerProvider: {
			message:
				"Allows for a script to capture your print jobs' content " +
		...
		sessions: {
			message:
				'Makes it possible for a script to get all recently ' +
		...
		topSites: {
			message:
				'Allows a script to your top sites, which are the sites ' +
		...
		tabCapture: {
			message:
				'Allows the capturing of the CURRENT tab and only ' +
		...
		tts: {
			message:
				"Allows a script to use chrome's text so speech engine. " +
				'(https://developer.chrome.com/extensions/tts)',
			description: 'Description for the tts permission',
		},
		webNavigation: {
			message:
				'Allows a script info about newly created pages and ' +
		...
		crmGet: {
			message:
				'Allows the reading of your Custom Right-Click Menu, ' +
		...
		crmWrite: {
			message:
				'Allows the writing of data and nodes to your Custom ' +
		...
		crmRun: {
			message:
				'Allows the running of arbitrary scripts from the background-page',
			description: 'Description for the crmRun permission',
		},
		crmContextmenu: {
			message:
				"Allows the editing of this item's name in the " +
		...
		GMAddStyle: {
			message:
				'Allows the adding of certain styles to the document ' +
				'through this API',
		...
		GMAddValueChangeListener: {
			...
			description:
				'Description for the GM_addValueChangeListener permission',
		},
		GMRemoveValueChangeListener: {
			message: 'Allows for the removing of listeners',
			description:
				'Description for the GM_removeValueChangeListener permission',
		},
		GMSetValue: {
		...
		GMGetTab: {
			message:
				"Allows the reading of an object that's persistent " +
				'while the tab is open - not implemented',
			description: 'Description for the GM_getTab permission',
		},
		GMSaveTab: {
			message:
				'Allows the saving of the tab object to reopen after ' +
		...
		unsafeWindow: {
			message:
				'Allows the running on an unsafe window object - ' +
	...
	langs: {
		...
		selector: {
			current: {
				message: 'current',
				description:
					'Word to signal this is the currently selected ' +
					'item, example: "english, current"',
			},
			clickToChangeLanguage: {
				message: 'Click here to change your language',
				description:
					'Used for a button that will allow you to change ' +
					'your language on click',
			},
			requestLanguage: {
				message:
					'Request a language or consider translating into yours',
				description:
					'Requesting a new language and/or translating ' +
	...
	crmApp: {
		...
		editor: {
			settings: {
				header: {
					...
					description:
						'Title header for the settings for the CRM editor',
				},
				theme: {
					message: 'Theme',
				...
				jslintGlobals: {
					...
					description:
						'Description of the jslint globals option ' +
		...
		crmtype: {
			toggle: {
				message:
					'Toggle showing items that are visible when ' +
					'right-clicking on $CONTENTTYPE$',
				description:
					'Clicking this button will toggle visibility ' +
		...
		options: {
			...
			catchErrors: {
				message:
					'Catch errors in scripts and log them. If off, ' +
			...
			showoptions: {
				...
				description:
					'The option to show the "options" link to the ' +
					'options page in the right-click menu',
			},
			recoverUnsavedData: {
				message:
					'Prompt you with an option to recover your unsaved ' +
			...
			CRMOnPageOption: {
				message:
					'Use your custom right-click menu on this page as a ' +
					"preview instead of your browser's regular one.",
				description: 'See message',
			},
			chromeLow: {
				message:
					'Your chrome version is too low for this to be ' +
					'possible (min is chrome 34, you have $VERSION$)',
				description:
					'A message informing the user that their browser ' +
			...
			notChrome: {
				message: 'not chrome',
				description:
					'Used in the form "min chrome version is 34, ' +
					'you have {not chrome}',
			},
			useStorageSyncDisabledUnavailable: {
				message: 'Syncing is not available in your browser',
				description:
					'Reason the useStorageSync option is disabled. ' +
			...
			useStorageSyncOption: {
				message:
					'Sync your storage across all browser instances signed ' +
			...
			editCRMInRM: {
				message:
					'Edit the custom right-click Menu by clicking on the ' +
		...
		defaultLinks: {
			header: {
				...
				description:
					'Header for the default/commonly used links section',
			},
			description: {
				message:
					'Here are some commonly used links to get you started. ' +
		...
		searchEngines: {
			...
			description: {
				message:
					'These are some commonly used search-engines.' +
		...
		uriScheme: {
			...
			description: {
				message:
					'You may want to launch programs on your computer as well, ' +
				...
				placeholders: {
					custom_uri_info: {
						content:
							'<a href="https://msdn.microsoft.com/en-us/library/' +
							'aa767914(VS.85).aspx" rel="noopener" target="_blank">' +
							'this</a>',
					},
					custom_uri_mac: {
						content:
							'<a rel="noopener" href="https://support.' +
					...
					custom_uri_windows: {
						content:
							'<a href="https://support.microsoft.com/nl-nl' +
			...
			filePathLabel: {
				...
				description:
					'A descriptive label for an input that allows ' +
					'the inputting of file paths',
			},
			invalidScheme: {
				message: 'This is not a valid scheme',
				description:
					'Error message saying that given URI scheme is invalid',
			},
			schemeNameLabel: {
				message: 'URI scheme name',
				description:
					'A descriptive label for an input that allows the ' +
					"inputting of the URI scheme's name",
			},
			example: {
				message: 'myscheme',
				description:
					'A name for an example scheme. This will be changed ' +
					'by the user later',
			},
			generate: {
				message: 'GENERATE',
				description:
					'A button that can be used to generate the ' +
					'custom URI scheme',
			},
		},
		importing: {
			...
			description: {
				message:
					'Here you can import your settings or CRM nodes from ' +
			...
			error: {
				message:
					'Something went wrong processing the data, please ' +
					'check the data',
				description:
					'Error that is shown when data importing has ' +
					'failed because processing failed.',
			},
			overwrite: {
				message: 'Overwrite',
				description:
					'Label for the "overwrite" option. Checking ' +
					'this overwrites previous settings',
			},
			overwriteTitle: {
				message:
					'Check this if you want to overwrite your CRM. ' +
			...
			legacy: {
				message: 'CRM legacy',
				description:
					'Label for the "CRM legacy" option. Checking this ' +
					'assumes the data comes from the (very) old version of ' +
					'the extension',
			},
			legacyTitle: {
				message:
					"Check this if you're importing from the old version " +
			...
			import: {
				message: 'Import',
				description:
					'Label for the main importing function. Imports ' +
		...
		exporting: {
			...
			description: {
				message:
					'Here you can export your settings and/or CRM. To ' +
					'export select ' +
			...
			waiting: {
				...
				description:
					'Message that is displayed while waiting for the exporting',
			},
			exportCRM: {
				message: 'Export your Custom Right-Click Menu',
				description:
					'Label for checkbox. When checked, exports the ' +
			...
			export: {
				message: 'Export',
				description:
					'Label for the main exporting function. Exports ' +
					'data from given string into the extension',
			},
		},
		help: {
			...
			description: {
				message:
					'If you need help with anything or you would simply ' +
				...
				placeholders: {
					wiki_link: {
						content:
							'<a rel="noopener" href="https://github.com/' +
		...
		contact: {
			...
			description: {
				message:
					'If you have found any bugs, thought of any suggestions or ' +
				...
				placeholders: {
					send_email: {
						content:
							'<a rel="noopener" href="mailto:awsdfgvhbjn@' +
							'gmail.com" target="_blank">awsdfgvhbjn@gmail.com</a>',
					},
					github: {
						content:
							'<a href="https://github.com/SanderRonde/"' +
		...
		bugs: {
			...
			description: {
				message:
					'If you would like to report any bugs, you can do ' +
		...
		globalExcludes: {
			...
			description: {
				message:
					"There are some sites on which you don't want any " +
					...
					'as follows ',
				description:
					'Description for the global excludes section ' +
					'(followed by a link)',
			},
			patternLabel: {
			...
			patternInvalid: {
				...
				description:
					'Error message that is displayed when the URL ' +
		...
		privacyPolicy: {
			...
			description: {
				message:
					'This extension does not store any personally ' +
		...
		toasts: {
			revert: {
				...
				description:
					'Toast that would undo the last action done by the user',
			},
			contentType: {
				message:
					'You need to select at least one content type to ' +
					'show this node on, otherwise it will never be shown. ' +
					'To hide it change the triggers.',
				description:
					'Warning telling the user that they need ' +
					'to have at least one content type selected',
			},
			storageExceeded: {
				message:
					'Storage sync has ran out of space, switched to ' +
			...
			noErrors: {
				...
				description:
					'Notification that is shown when there are no ' +
					'more errors to step through',
			},
			acceptDownload: {
				message:
					'Please accept the permission request to report a ' +
					'bug or suggest a feature',
				description:
					'Notification asking the user to accept the ' +
		...
		dialogs: {
			...
			recoverUnsaved: {
				...
				description: {
					message:
						'You closed an editing instance without saving or ' +
						'discarding it, are you sure you wanted to do this?',
					description:
						'Question asking the user if they want to ' +
						'discard these changes',
				},
				whatNode: {
					message: 'What node?',
					description:
						'Button that shows the user what script has changed',
				},
				oldCode: {
					message: 'Old Code',
			...
			addLibrary: {
				...
				urlError: {
					...
					description:
						'Error message shown when the URL does not ' +
						'host anything (error 404)',
				},
				usesTypescript: {
					message: 'Check if library uses typescript',
					description:
						'Option that should be checked when the library ' +
						'the user inputs uses typescript',
				},
				isThisOkay: {
					message: 'Does this look okay to you?',
					description:
						'Question asking the user if the code looks fine',
				},
				added: {
					message: 'Added!',
					description:
						'Message telling the user that the library ' +
			...
			cssEditorInfo: {
				...
				description: {
					message:
						'- Use $URL_REFERENCE$ to run certain CSS only on ' +
					...
					placeholders: {
						url_reference: {
							content:
								'<pre class="inlineCodePre">@url ' +
								"'http://example.com';</pre>",
						},
						url_end: {
							content:
								'<pre class="inlineCodePre">@urlend;</pre>',
						},
						url: {
			...
			exporting: {
				...
				description: {
					message:
						'You can copy the data below and paste it in a ' +
				...
				authorName: {
					...
					description:
						"Label for an input containing the author's " +
			...
			permissions: {
				description: {
					message:
						'Here you can allow or disallow permissions for ' +
				...
				usedPermissions: {
					...
					description:
						'A header for a list of permissions that are ' +
						'used by this script',
				},
			},
			requestPermissions: {
				header: {
					...
					description:
						'Header for the allow/request permission dialog',
				},
				description: {
					message:
						'A script that you presumably wrote or added has ' +
				...
				required: {
					message: 'Required',
					description:
						'Word for a required permission as requested by ' +
						'the extension author',
				},
				others: {
					message: 'Others',
					description:
						'Word for other permissions that are not ' +
						'necessarily required.',
				},
				acceptAll: {
					message: 'Accept all required',
					description:
						'Button that accepts (enables) all permissions ' +
						'that are required',
				},
			},
			addedPermissions: {
				header: {
					...
					description:
						'Header signaling that a script with given ' +
		...
		code: {
			nodeUpdated: {
				message:
					'Node $NAME$ was updated from version $OLDVERSION ' +
					'to version $NEWVERSION',
				description:
					'A message telling the user a node has been updated',
				placeholders: {
					name: {
						content: '$1',
						example: 'MyNode',
			...
			extensionUpdated: {
				...
				description:
					'Message telling the user the extension has been updated',
				placeholders: {
					version: {
						content: '$1',
						example: '1.2.3',
			...
			settingsUpdated: {
				...
				description:
					'Message telling the user their settings were ' +
			...
			hiMessage: {
				message:
					"Hey there, if you're interested in how this " +
					'extension works check out the github repository over ' +
					'at https://github.com/SanderRonde/CustomRightClickMenu',
				description:
					'Message meant for developers looking to see ' +
					'how this extension works',
			},
			consoleInfo: {
				message:
					'To get information about how to edit settings from ' +
					'the console ' +
			...
			permissionsNotSupported: {
				...
				description:
					'Message shown when browser.permissions API is ' +
					'unsupported by the browser',
			},
			downloadNotSupported: {
				message:
					'Your browser does not support asking for the download ' +
					'permission',
				description:
					'Message shown when browser.download API is ' +
					'unsupported by the browser',
			},
			importSuccess: {
				message: 'Successfully imported your data',
				description:
					'Message shown when data importing has ' +
					'completed successfully',
			},
			alreadyEditingNode: {
				message: 'Please close the current dialog first',
				description:
					'Message shown when a node is already being edited ' +
					"and another one can't be edited before closing the other one",
			},
			wouldExecuteScript: {
				message: 'This would execute a script',
				description:
					'Message shown when clicking a script node in the ' +
			...
			wouldExecuteStylesheet: {
				...
				description:
					'Message shown when clicking a stylesheet ' +
	...
	background: {
		crm: {
			invalidRunat: {
				...
				description:
					'runAt value is not valid for script with given id.' +
			...
			executionFailed: {
				message:
					"Couldn't execute on tab with id $TABID$" +
					'for node $NODEID$',
			...
			setupError: {
				message:
					'An error occurred while setting up the script for ' +
					'node $NODEID$',
				description:
					'A message shown when an error has occurred in ' +
					'the setup stage',
				placeholders: {
					nodeid: {
						content: '$1',
			...
			updateDownload404: {
				message:
					'Tried to update $NODETYPE$ $NODEID$ $NODENAME$' +
					' but could not reach download URL',
				description:
					"A message shown when a request to a node's " +
			...
			optionNotFound: {
				message:
					'Could not find option $NODENAME$ for stylesheet $NODEID$',
				description:
					'A message shown when a key was not found in ' +
			...
			cssCompileError: {
				message:
					'An error occurred while compiling $TYPE$ CSS for ' +
					'node $NODEID$',
				description:
					'An error shown when compilation failed for ' +
			...
			contextmenuErrorRetry: {
				message:
					'An error occurred with your context menu,' +
					' attempting again with no url matching.',
				description:
					'Error shown when something went wrong creating ' +
			...
			userContextmenuError: {
				...
				description:
					'Error shown when something went wrong creating a ' +
			...
			createdBackgroundPage: {
				...
				description:
					'Message shown when a backgroundpage for given ' +
					'node has started',
				placeholders: {
					nodeId: {
						content: '$1',
		...
		globalDeclarations: {
			getID: {
				noMatches: {
					message:
						'Unfortunately no matches were found, please try again',
					description:
						'Message shown when the getID function finds no results',
				},
				oneMatch: {
					message:
						'One match was found, the id is $MATCHID$' +
						' and the script is',
					description:
						'Message shown when the getID function finds one ' +
				...
				multipleMatches: {
					...
					description:
						'Message shown when the getID function finds ' +
						'multiple results',
				},
			},
			tabRestore: {
				success: {
					...
					description:
						'Message shown when a tab that was already ' +
				...
				ignored: {
					message:
						'Ignoring tab with id $TABID$ (chrome or file url)$',
					description:
						'Message shown when a tab that was already ' +
						'open when the extension started is retroactively ' +
				...
				frozen: {
					message:
						'Skipping restoration of tab with id $TABID$' +
			...
			proxy: {
				redirecting: {
					message: 'Redirecting',
					description:
						'Message shown when redirecting a URL to another URL',
				},
			},
		},
		init: {
			loggingExplanation: {
				message:
					"If you're here to check out your background " +
					...
					'$LOGGINGURL$',
				description:
					'Message shown to inform the user of the ' +
			...
			debugExplanation: {
				message:
					'You can also use the debugger for scripts by ' +
			...
			registeringPermissionListeners: {
				...
				description:
					'Info message shown when registers listeners ' +
			...
			registeringHandler: {
				...
				description:
					'Info message shown when setting up message ' +
					'handler for the CRM API. Handling API requests from scripts',
			},
			buildingCrm: {
				message: 'Building Custom Right-Click Menu',
				description:
					'Info message shown when building the contextmenu itself',
			},
			compilingTs: {
				message: 'Compiling typescript',
				description:
					'Info message shown when typescript is being compiled',
			},
			registeringHandlers: {
				message: 'Registering global handlers',
				description:
					'Info message shown when registering general ' +
					'global change handlers (tabs created/removed etc)',
			},
			updatingResources: {
				message: 'Updating resources',
				description:
					'Info message shown when updating resources, which ' +
					'are scripts hosted on other websites',
			},
			updatingNodes: {
				message: 'Updating scripts and stylesheets',
				description:
					'Info message shown when updating scripts and ' +
					"stylesheets's code",
			},
			debugInfo: {
				message:
					'For all of these arrays goes, close and re-expand ' +
					'them to "refresh" their contents',
				description:
					'Info message telling the user how to refresh ' +
					'arrays in the console',
			},
			invalidatedTabs: {
				message: 'Invalidated tabs:',
				description:
					'Label for array that contains invalidated tabs. ' +
			...
			previousOpenTabs: {
				...
				description:
					'Message group for the restoration of already-open tabs',
			},
			backgroundpages: {
				message: 'Creating backgroundpages',
				description:
					'Message group for the creation of backgroundpages',
			},
			debugging: {
				message: 'Debugging',
		...
		storages: {
			syncUploadError: {
				message:
					'Error on uploading to storage.sync, uploading to ' +
					'storage.local instead',
				description:
					'Error shown when uploading user settings to ' +
			...
			buildingCrm: {
				...
				description:
					'Info message shown when building CRM and its ' +
					'in-background tree representation',
			},
			loadingSync: {
				message: 'Loading sync storage data',
				description:
					'Info message shown when loading the ' +
			...
			checkingFirst: {
				...
				description:
					'Info message shown when checking if this ' +
					'is the very first run of the extension',
			},
			parsingData: {
				message: 'Parsing data encoding',
				description:
					'Info message shown when parsing the stored data ' +
			...
			checkingUpdates: {
				...
				description:
					'Info message shown when checking whether any ' +
			...
			initializingFirst: {
				...
				description:
					'Info message shown when initializing the initial ' +
		...
		logging: {
			background: {
				message: 'background',
				description:
					'Name for a page that runs in the background ' +
	...
	install: {
		confirm: {
			installed: {
				message: 'Installed!',
				description:
					'Success message shown when installation completes',
			},
			description: {
				message: 'Description',
			...
			source: {
				message: 'Source',
				description:
					'Label for source field. Source being the URL ' +
			...
			permissionInfo: {
				message:
					'Not accepting a permission might lead to scripts ' +
					'silently failing.' +
			...
			noneRequired: {
				...
				description:
					'Message shown when no permissions are ' +
					'required for a script',
			},
			none: {
				message: 'none',
				description:
					'Shown when there are no permissions required ' +
			...
			notAsking: {
				message:
					'Not asking for permission $PERMISSION$ as your ' +
					'browser does not support asking for permissions',
				description:
					'Message shown when requesting permissions ' +
					'is not supported',
				placeholders: {
					permission: {
						content: '$1',
		...
		error: {
			notFound1: {
				message: 'Userscript',
				description:
					'Part 1 of the message "userscript not found"' +
			...
			notFound2: {
				message: 'Not Found',
				description:
					'Part 2 of the message "userscript not found"' +
		...
		page: {
			fetching: {
				...
				description:
					'State shown when downloading/fetching the userscript',
			},
			failedXhr: {
				message: 'Failed XHR',
			...
			installing: {
				...
				description:
					'State shown when installing a userscript from given URL',
				placeholders: {
					source: {
						content: '$1',
	...
	logging: {
		filter: {
			message: 'filter',
			description:
				'A filter that only lists items that match give filter text',
		},
		description: {
			message:
				'This page serves as a sort of devTools for specific ' +
		...
		lines: {
			message: 'lines',
			description:
				'Prefixed by the amount of logging lines there are ' +
				'in the logging console',
		},
		runningCodeNotPossible: {
			message:
				'Running code is not possible in the current context ' +
				'(select both an ID and a tab)',
			description:
				'Warning that running code is not possible right ' +
				'now since no context has been selected.',
		},
		storeAsLocal: {
			message: 'Store as local variable',
			description:
				'Stores clicked javascript value in a local value so ' +
		...
		copyPath: {
			message: 'Copy path',
			description:
				'Copies the path to a value. For example if the user ' +
		...
		tabClosed: {
			...
			description:
				'Warning that a tab has been closed and as such ' +
				"its log won't be updated",
		},
		somethingWentWrong: {
			message: 'Something went wrong highlighting the tab',
			description:
				'Generic warning shown when an error occurred on ' +
		...
		logs: {
			message: 'Logs',
			description:
				'Title for this page. Describes that this is the ' +
	...
	util: {
		errorReportingTool: {
			finish: {
				message: 'Finish',
				description:
					'Finishes the action of highlighting the error/bug',
			},
			title: {
			...
			description: {
				message:
					'You can report a bug that happened or a feature you ' +
			...
			pageCapture: {
				...
				description:
					'Launches a page capturing program with which ' +
					'the user can select ' +
			...
			reportingBug: {
				...
				description:
					'Button to press when reporting a bug/fault in ' +
					'the extension',
			},
			suggestingFeature: {
				message: 'Suggesting a feature',
				description:
					'Button to press when suggesting a new feature ' +
					'for the extension',
			},
			submit: {
				message: 'submit',
	...
	options: {
		nodeEditBehavior: {
			globPattern: {
				...
				description:
					'Label shown for an input that wants either a ' +
					'glob pattern or regex',
			},
			matchPattern: {
				message: 'URL match pattern',
				description:
					'Label shown for an input that wants a URL match pattern',
			},
		},
		crmEditPage: {
			createdBy: {
			...
			installedFrom: {
				...
				description:
					'Label displaying where a script was downloaded from. ' +
					'Keep in mind that the "url" word in the placeholder ' +
					'should be replaced as well',
				placeholders: {
					sourceURL: {
						content:
							'<span id="nodeInfoFrom"><b>' +
			...
			createdByYou: {
				message: 'Created by $AUTHOR$',
				description:
					'Label displaying the author of a script. This is ' +
					'the same as the ' +
			...
			hasAllPermissions: {
				message:
					'This means it has access to all permissions ' +
					'without having to enable them',
				description:
					'Describes the additional permissions enabled ' +
					'when a script ' +
		...
		defaultLink: {
			name: {
				message: 'Name',
				description:
					'The name for a website. For example for ' +
					'www.google.com ' +
		...
		editCrm: {
			empty: {
				message:
					'It seems like there is no right-click menu for ' +
					'this content type, try something else or add a new node!',
				description:
					'Message shown when the CRM is empty for ' +
					'given content type',
			},
			addHere: {
				message: 'Add Here',
				description:
					'Click location for adding a new node. When clicked ' +
			...
			addNodeType: {
				...
				placeholders: {
					nodeType: {
						content: '$1',
						example:
							'Internationalized version of Link, Script, ' +
							'Stylesheet etc',
					},
				},
			},
			select: {
				message: 'Select',
				description:
					'Enables selection mode in which you can select nodes ' +
					'and do things like deleting/moving them.',
			},
			exportSelected: {
				message: 'Export Selected',
				description:
					'Exports the nodes selected in selection mode. ' +
			...
			menuRemoveWarning: {
				message:
					'Warning: Children of a removed menu will also be ' +
					'removed recursively!',
				description:
					'Warning telling the user that if a node of type menu ' +
					'is removed, its children will also be removed.',
			},
			dragInfo: {
				message:
					'Click and hold the three dashes ($HANDLE$) to drag ' +
					'the nodes.',
				description:
					'Description on how to use the dragging handle to ' +
					'drag nodes around.',
				placeholders: {
					handle: {
						content:
			...
			menuInfo: {
				message:
					"Click the arrows ($ARROW$) to show a menu's contents.",
				description:
					"Description of how to expand a menu's children/contents",
				placeholders: {
					arrow: {
						content:
							'<svg class="infoSvg triangleInfoSvg" ' +
			...
			addFail: {
				...
				description:
					'Error message shown when the adding of a node of ' +
		...
		editCrmItem: {
			changeType: {
				...
				description:
					'Title of an element that changes the type of a node',
			},
			dragNode: {
				message: 'Click and hold to drag node around',
				description:
					'Title of an element that moves a node around when ' +
					'dragging it',
			},
			clickToShowChildren: {
				message: 'Click to show children',
				description:
					"Title for an element that shows a menu node's children",
			},
			...
			clickToShowChild: {
				...
				description:
					"Title for an element that shows a menu node's child",
			},
			rootName: {
				message: 'Custom Menu',
			...
			clickToEditRoot: {
				...
				description:
					'Title for a button that allows editing/changing of the ' +
					"root node's name",
			},
			nodeHidden: {
				message:
					"This node won't be visible on this content type " +
					'(select a different one in the top-right corner)',
				description:
					'Title for a hidden node. A different content type can be ' +
			...
			clickToEdit: {
				...
				description:
					'Title for an element that, on-click edits a regular node',
			},
		},
		tools: {
			paperGetPageProperties: {
				selection: {
					message: 'Selection',
					description:
						'Name for the current text selection in a browser',
				},
				host: {
					message: 'Host',
					description:
						'The host of a URL. For example for ' +
						'www.google.com/example this would be www.google.com',
				},
				path: {
					message: 'Path',
					description:
						'The path of a URL. For example for ' +
						'www.google.com/example this would be /example',
				},
				protocol: {
					message: 'Protocol',
					description:
						'The protocol of a URL. this is the part ' +
				...
				clickedElement: {
					...
					description:
						'The element that was right-clicked on when ' +
			...
			paperLibrariesSelector: {
				libraryInfo: {
					message:
						'Try to refrain from using unnecessary libraries, libraries ' +
				...
				libraries: {
					message: 'Libraries',
					description:
						'Label for a list of javascript/typescript libraries',
				},
				anonymous: {
					message: 'anonymous',
				...
				addOwn: {
					...
					description:
						'Label for a button that allows you to add ' +
						'your own library',
				},
				xhrFailedMsg: {
					message:
					...
					description:
						'Message shown when a request to a script fails',
					placeholders: {
						statusCode: {
							content: '$1',
							example: '404',
				...
				nameTaken: {
					...
					description:
						'Error shown when the name for a library is ' +
						'already taken',
				},
				nameMissing: {
					message: 'Please enter a name',
				...
				pleaseUpdate: {
					message:
						'Please update your chrome (at least chrome 30) to use ' +
						'this feature',
					description:
						'Message shown when chrome version is too low ' +
			...
			paperSearchWebsiteDialog: {
				...
				description: {
					message:
						'This code will search given website for any ' +
						'text you highlight,' +
				...
				inputDefault: {
					...
					description:
						'Option to choose one of the default search engines',
				},
				chooseDefault: {
					message: 'Choose a default search engine',
					description:
						'Title for choosing one of the default search engines',
				},
				try: {
					message: 'Try',
				...
				manualInput: {
					...
					description:
						'Title for the manual search engine input window',
				},
				findingSearchURL: {
				...
				chooseFromList: {
					message:
						'By choosing from a list of your visited ' +
						'websites (chrome only)',
					description:
						'Option to select a search-engine from a ' +
						'list of your ' +
						'visited websites in your settings',
				},
				goToWebsite: {
					message:
						'Please go to the website you want to search. ' +
						'Search for ' +
						'"customRightClickMenu" without quotes and then paste the URL ' +
						'in the input below.',
					description:
						'Instructs the user to go to the website they want ' +
						'to search and search for the given string',
				},
				clickOmnibar: {
					message:
						'Please right-click the omnibar (the white bar above any page) ' +
					...
					description:
						'Instructs the user to go to the "edit search engines" page',
				},
				pasteHere: {
					message: 'paste here',
					description:
						'Input in which the copied data needs to be pasted',
				},
				invalidInput: {
				...
				process: {
					message: 'Process',
					description:
						'Process the pasted data and extract possible ' +
						'search engines',
				},
				processedTitle: {
					message: 'Choose the binding you want from this list',
					description:
						'Title for the list of processed items. ' +
				...
				choose: {
					message: 'Choose',
					description:
						'Confirm that you want to choose some search engine',
				},
				confirmTitle: {
					message:
						'Here you can test whether the given URL gives the ' +
						'expected results',
				...
				searchQuery: {
					...
					description:
						'Title for the search query field. ' +
				...
				testURL: {
					message: 'Test URL:',
					description:
						'The URL that will be outputted when ' +
				...
				howOpenTitle: {
					...
					description:
						'Title for the how to open field. This will give ' +
						'the choice between opening in the current tab or in a new tab',
				},
				newTab: {
					message: 'A new tab',
					description:
						'The option to open the URL in a new browser tab',
				},
				currentTab: {
					message: 'The current tab',
					description:
						'The option to open the URL in the current tab',
				},
				added: {
					message: 'Added!',
					description:
						'Message shown when adding search engine has ' +
						'completed. Try to keep this short',
				},
				enterSearchQuery: {
					message: 'Please enter a search query',
					description:
						'Prompt shown to the user when they need to ' +
						'add a search query',
				},
				selectSomething: {
					message: 'Please select something',
					description:
						'Message shown when no option has been selected',
				},
			},
		},
		editPages: {
			generic: {
				...
				contentTypeTitle: {
					message:
						'Toggle showing this item when right-clicking ' +
						'$CONTENTTYPE$',
				...
				showOnSpecified: {
					...
					description:
						'Checkbox that allows you to enable ' +
				...
				regexDescr: {
					message:
						'Regex is available, check the syntax ' +
						'$PREHTML$here$POSTHTML$.',
					description:
						'Info section explaining that regex is available',
					placeholders: {
						prehtml: {
							content:
				...
				not: {
					message: 'NOT',
					description:
						'Inverts given input when checked. ' +
				...
				invalidURLPattern: {
					message: 'This is not a valid URL pattern!',
					description:
						'Error message shown when match pattern is invalid',
				},
				changeType: {
					message: 'CHANGE TYPE',
			...
			link: {
				linkLabel: {
					message: 'Link(s)',
					description:
						'Label for the link section where you can ' +
						'configure the links this node will open',
				},
				currentTab: {
					message: 'Open in current tab',
					description:
						'Option that, when enabled, will open the URLs ' +
			...
			metadata: {
				...
				exclude: {
					message:
						'Exclude URLs even if they are included by **@include** or **@match**',
					description: 'Metadata for the "exclude" key',
				},
				require: {
					message:
						'Points to a javascript file that is loaded and executed before the script itself',
					description: 'Metadata for the "require" key',
				},
				resource: {
					message:
						'The Preloads resources that can be accessed by `GM_getResourceURL` and `GM_getResourceText` by the script of this script',
					description: 'Metadata for the "resource" key',
				},
				connect: {
					message:
						'Domains which are allowed to be retrieved by `GM_xmlhttpRequest`',
					description: 'Metadata for the "connect" key',
				},
				runAt: {
					message:
						'The moment the script is injected (document-start, document-body, document-end, document-idle or document-menu)',
				...
				noframes: {
					message:
						'Makes the script run on the main page but not in iframes',
					description: 'Metadata for the "noframes" key',
				},
				CRMContentTypes: {
					message:
						'The content types on which to run this script as a 6 items long boolean array (e.g. [true, false, true, false, true, false]) (CRM ONLY)',
					description: 'Metadata for the "CRM_contentTypes" key',
				},
				CRMLaunchMode: {
					message:
						'When to run this script. 0 = Run on clicking, 1 = always run, 2 = run on specified, 3 = show on specified, 4 = disabled. (CRM ONLY)',
					description: 'Metadata for the "CRM_launchMode" key',
				},
				CRMStylesheet: {
					message:
						'Interpret this as a stylesheet (userstyle) instead of a script (userscript). (CRM ONLY)',
					description: 'Metadata for the "CRM_stylesheet" key',
				},
				CRMToggle: {
					message:
						'A boolean value (true/false) indicating whether to allow toggling this stylesheet on or off. Only used when @CRM_stylesheet is present. (CRM ONLY)',
					description: 'Metadata for the "CRM_toggle" key',
				},
				CRMDefaultOn: {
					message:
						'A boolean value (true/false) indicating whether this stylesheet is toggled on by default. Only used when @CRM_stylesheet and @CRM_toggle are present. (CRM ONLY)',
					description: 'Metadata for the "CRM_defaultOn" key',
				},
				CRMLibraries: {
					message:
						'An array containing stringified objects with a "url" and a "name" key, pointing to external libraries used in this script.',
					description: 'Metadata for the "CRM_libraries" key',
				},
				license: {
					message:
						"The license for this script. If none is supplied, it's under exclusive copyright by default",
					description: 'Metadata for the "license" key',
				},
				preprocessor: {
					message:
						"The css preprocessor to use, choose from 'less', 'stylus', 'uso' or 'default'. For more info check out https://github.com/openstyles/stylus/wiki/Usercss#preprocessor",
					description: 'Metadata for the "preprocessor" key',
				},
				var: {
					message:
						'A variable that can be changed by the user and is replaced when compiling the stylesheet',
			...
			monaco: {
				...
				scriptStart: {
					...
					description:
						'Short description for the Userscript start tag',
				},
				scriptEnd: {
				...
				styleStart: {
					...
					description:
						'Short description for the Userstyle start tag',
				},
				styleEnd: {
				...
				disableMeta: {
					...
					description:
						'Description for a button that allows you to ' +
				...
				keyDescriptionUnknown: {
					...
					description:
						'Long description for metadata keys when the key is unknown',
					placeholders: {
						metaKey: {
							content: '$1',
							example: 'Name',
				...
				valueForKey: {
					...
					description:
						'Description shown when hovering over a key-value combination',
					placeholders: {
						value: {
							content: '$1',
							example: 'SomeValue',
				...
				disableUnderline: {
					...
					description:
						'Label for a button that disables underlining of ' +
						'colors in CSS',
				},
				enableUnderline: {
					message: 'Enable CSS underline',
					description:
						'Label for a button that enables underlining of ' +
						'colors in CSS',
				},
				optionName: {
					message: 'The name of the option',
					description:
						'Label for the "name" field of an option config',
				},
				numberOption: {
				...
				valueExpanded: {
					message:
						'The value of this option, changing it here will have the' +
				...
				selected: {
					...
					description:
						'Label for the "selected" field which ' +
				...
				values: {
					...
					description:
						'Label for the "values" field which ' +
				...
				maxItems: {
					...
					description:
						'Label for the "maxItems" field of an ' +
						'array-type option, which limits the max amount of ' +
						'values that can be inputted',
				},
				items: {
					message:
						'The type of items this array contains (number or string)',
					description:
						'Label for the "items" field of an array-type option ' +
				...
				lintingDisabled: {
					...
					description:
						'Message shown when linting is not possible in this mode',
					placeholders: {
						mode: {
							content: '$1',
			...
			script: {
				autoUpdate: {
					...
					description:
						'Button that toggles automatically updating ' +
						'the script when a new version is hosted on the source',
				},
				permissions: {
					message: 'Used Permissions(s)',
					description:
						'Title for the used permissions of this script. ' +
				...
				script: {
					message: 'Script',
					description:
						'Title for the script editing section ' +
						'of a javascript script node',
				},
				docs: {
					message: 'docs',
					description:
						'Button that opens the documentation of the API' +
						'when clicked',
				},
				scriptMain: {
					message: 'Main',
					description:
						'Main section of the script. This is the script ' +
						'that is run on the page, not a background-script',
				},
				scriptBackground: {
					message: 'Background',
					description:
						'Background section of the script. This script ' +
						'is ran in the background like an extension background-page',
				},
				scriptOptions: {
					message: 'Options',
					description:
						'Options editor for a script. These allow for ' +
						'custom options to be passed to a script',
				},
				scriptLibraries: {
					message: 'Libraries',
					description:
						'Library editor. Libraries are external scripts ' +
						'ran whenever this script is ran',
				},
				showBackgroundLibs: {
					message: 'Show backgroundscript libraries',
					description:
						'Button that toggles showing libraries for the ' +
						'background script',
				},
				crmNode: {
					message: 'CRM Node',
					description:
						'One of the options to which a script can be ' +
			...
			code: {
				triggers: {
					message: 'Trigger(s)',
					description:
						'Title for the triggers section. ' +
				...
				triggerOnClick: {
					...
					description:
						'Trigger option that makes the script/stylesheet ' +
				...
				triggerShowOnSpecified: {
					message: 'Show only on specified sites',
					description:
						'Trigger option that only shows the script/stylesheet ' +
						'on specified websites',
				},
				triggerDisabled: {
					message: 'Disabled',
					description:
						'Disables this script/stylesheet altogether and ' +
				...
				showOn: {
					message: 'Show on:',
					description:
						'Label for the showing of a node in the right-click ' +
						'menu on specified websites',
				},
				executeOn: {
					message: 'Execute on:',
					description:
						'Label for the executing of a node in the right-click ' +
						'menu on specified websites',
				},
				triggerInfo: {
					message:
						'For trigger mode "execute when visiting sides" urls need ' +
					...
					placeholders: {
						executePreHtml: {
							content:
								'<a href="https://wiki.greasespot.net/Include_and_' +
								'exclude_rules" rel="noopener" target="_blank">',
						},
						matchPreHTML: {
							content:
								'<a href="https://developer.chrome.com/extensions/match_' +
				...
				backgroundInfo: {
					message:
						"The background page will always be running. It's " +
						'possible to communicate with it using the $COMMAPI$. ' +
						'The scripts only share their permissions.',
					description:
						'Info about the background script and what it does',
					placeholders: {
						commAPI: {
							content:
								'<a href="http://sanderronde.github.io' +
				...
				optionsInfo: {
					message:
						'Create a key and press Ctrl+Space for format hints ' +
					...
					description:
						'Info about the options editor and how it works',
					placeholders: {
						preHTML: {
							content:
								'<a href="http://sanderronde.github.io/' +
				...
				settings: {
					message: 'Editor Settings',
					description:
						'Title for the settings section. This allows ' +
				...
				fontSize: {
					message: 'font size %',
					description:
						'The font size of the editor. Include the % sign ' +
						"in some way to convey that it's displayed in percentages",
				},
				globals: {
					message: 'Comma separated list of JSLint globals',
					description:
						'A list of global javascript values that ' +
				...
				exportAs: {
					message: 'EXPORT AS',
					description:
						'Allows you to export a script/stylesheet. ' +
			...
			stylesheet: {
				togglable: {
					...
					description:
						'A button that sets whether a stylesheet ' +
				...
				toggleInfo: {
					message:
						'Non-togglable CSS is not in the right-click ' +
				...
				stylesheet: {
					message: 'Stylesheet',
					description:
						'The stylesheet itself in this node that ' +
						'can be edited',
				},
				optionsInfo: {
					message:
						'See $PRESTYLUSHTML$this page$POSTHTML$ for more ' +
