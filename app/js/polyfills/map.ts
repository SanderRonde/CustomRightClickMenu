...
class MapPolyfill<K, V> {
	...
	forEach<U = any>(
		callbackFn: (this: U, value: V, key: K, map: MapPolyfill<K, V>) => void,
		thisArg?: U
	) {
...
interface CRMStore<N extends CRM.Node = CRM.Node>
	extends MapPolyfill<CRM.NodeId<N> | CRM.GenericNodeId, N> {
