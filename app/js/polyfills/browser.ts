	...
	contextMenus: {
		create(createProperties: {
			...
			return __chrome.contextMenus.create(createProperties as any, () => {
				...
				if (__chrome.runtime.lastError) {
					browserPolyfill.runtime.lastError = __chrome.runtime.lastError.message;
					callback();
					browserPolyfill.runtime.lastError = null;
				} else {
					callback();
				}
			});
...
window.browser = window.browser || browserPolyfill as typeof _browser;